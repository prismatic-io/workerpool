...
describe('Pool', function () {
  ...
  it('should return statistics', function () {
    ...
    assert.deepStrictEqual(pool.stats(), {totalWorkers: 0, busyWorkers: 0, exhaustedWorkers: 0, idleWorkers: 0, pendingTasks: 0, activeTasks: 0});

    var promise = pool.exec(test)
        .then(function () {
          assert.deepStrictEqual(pool.stats(), {totalWorkers: 1, busyWorkers: 0, exhaustedWorkers: 0, idleWorkers: 1, pendingTasks: 0, activeTasks: 0 });
          ...
          assert.deepStrictEqual(pool.stats(), {totalWorkers: 4, busyWorkers: 4, exhaustedWorkers: 0, idleWorkers: 0, pendingTasks: 2, activeTasks: 4});

          return all;
        })
        .then(function () {
          assert.deepStrictEqual(pool.stats(), {totalWorkers: 4, busyWorkers: 0, exhaustedWorkers: 0, idleWorkers: 4, pendingTasks: 0, activeTasks: 0 });
    ...
    assert.deepStrictEqual(pool.stats(), {totalWorkers: 1, busyWorkers: 1, exhaustedWorkers: 0, idleWorkers: 0, pendingTasks: 0, activeTasks: 1});
